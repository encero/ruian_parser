...
func (c *Client) init() {
	...
	c.AddressPlace = NewAddressPlaceClient(c.config)
...
func (c *Client) Tx(ctx context.Context) (*Tx, error) {
	...
	return &Tx{
		ctx:          ctx,
		config:       cfg,
		AddressPlace: NewAddressPlaceClient(cfg),
...
func NewAddressPlaceClient(c config) *AddressPlaceClient {
	return &AddressPlaceClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `addressplace.Hooks(f(g(h())))`.
func (c *AddressPlaceClient) Use(hooks ...Hook) {
	c.hooks.AddressPlace = append(c.hooks.AddressPlace, hooks...)
}

// Create returns a create builder for AddressPlace.
func (c *AddressPlaceClient) Create() *AddressPlaceCreate {
	mutation := newAddressPlaceMutation(c.config, OpCreate)
	return &AddressPlaceCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}
...
func (c *AddressPlaceClient) CreateBulk(builders ...*AddressPlaceCreate) *AddressPlaceCreateBulk {
	return &AddressPlaceCreateBulk{config: c.config, builders: builders}
}

// Update returns an update builder for AddressPlace.
func (c *AddressPlaceClient) Update() *AddressPlaceUpdate {
	mutation := newAddressPlaceMutation(c.config, OpUpdate)
	return &AddressPlaceUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *AddressPlaceClient) UpdateOne(ap *AddressPlace) *AddressPlaceUpdateOne {
	mutation := newAddressPlaceMutation(c.config, OpUpdateOne, withAddressPlace(ap))
	return &AddressPlaceUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *AddressPlaceClient) UpdateOneID(id int32) *AddressPlaceUpdateOne {
	mutation := newAddressPlaceMutation(c.config, OpUpdateOne, withAddressPlaceID(id))
	return &AddressPlaceUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for AddressPlace.
func (c *AddressPlaceClient) Delete() *AddressPlaceDelete {
	mutation := newAddressPlaceMutation(c.config, OpDelete)
	return &AddressPlaceDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a delete builder for the given entity.
func (c *AddressPlaceClient) DeleteOne(ap *AddressPlace) *AddressPlaceDeleteOne {
	return c.DeleteOneID(ap.ID)
}

// DeleteOneID returns a delete builder for the given id.
func (c *AddressPlaceClient) DeleteOneID(id int32) *AddressPlaceDeleteOne {
	builder := c.Delete().Where(addressplace.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &AddressPlaceDeleteOne{builder}
}

// Query returns a query builder for AddressPlace.
func (c *AddressPlaceClient) Query() *AddressPlaceQuery {
...
func (c *AddressPlaceClient) Get(ctx context.Context, id int32) (*AddressPlace, error) {
	return c.Query().Where(addressplace.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *AddressPlaceClient) GetX(ctx context.Context, id int32) *AddressPlace {
...
func (c *AddressPlaceClient) QueryStreets(ap *AddressPlace) *StreetQuery {
	...
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(addressplace.Table, addressplace.FieldID, id),
...
func (c *CityClient) QueryStreet(ci *City) *StreetQuery {
	...
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.To(street.Table, street.FieldID),
			sqlgraph.Edge(sqlgraph.M2M, true, city.StreetTable, city.StreetPrimaryKey...),
		)
...
func (c *StreetClient) QueryCities(s *Street) *CityQuery {
	...
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.M2M, false, street.CitiesTable, street.CitiesPrimaryKey...),
		)
...
func (c *StreetClient) QueryAdresses(s *Street) *AddressPlaceQuery {
	query := &AddressPlaceQuery{config: c.config}
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		id := s.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(street.Table, street.FieldID, id),
			sqlgraph.To(addressplace.Table, addressplace.FieldID),
			sqlgraph.Edge(sqlgraph.M2M, true, street.AdressesTable, street.AdressesPrimaryKey...),
		)
		fromV = sqlgraph.Neighbors(s.driver.Dialect(), step)
		return fromV, nil
	}
