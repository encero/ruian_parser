...
func ID(id int32) predicate.City {
...
func IDEQ(id int32) predicate.City {
	return predicate.City(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDNEQ(id int32) predicate.City {
	return predicate.City(func(s *sql.Selector) {
...
func IDIn(ids ...int32) predicate.City {
	return predicate.City(func(s *sql.Selector) {
...
func IDNotIn(ids ...int32) predicate.City {
	return predicate.City(func(s *sql.Selector) {
		// if not arguments were provided, append the FALSE constants,
		// since we can't apply "IN ()". This will make this predicate falsy.
		if len(ids) == 0 {
...
func IDGT(id int32) predicate.City {
	return predicate.City(func(s *sql.Selector) {
...
func IDGTE(id int32) predicate.City {
	return predicate.City(func(s *sql.Selector) {
...
func IDLT(id int32) predicate.City {
	return predicate.City(func(s *sql.Selector) {
...
func IDLTE(id int32) predicate.City {
	return predicate.City(func(s *sql.Selector) {
...
// HasStreet applies the HasEdge predicate on the "street" edge.
func HasStreet() predicate.City {
	return predicate.City(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(StreetTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2M, true, StreetTable, StreetPrimaryKey...),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasStreetWith applies the HasEdge predicate on the "street" edge with a given conditions (other predicates).
func HasStreetWith(preds ...predicate.Street) predicate.City {
	return predicate.City(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(StreetInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2M, true, StreetTable, StreetPrimaryKey...),
		)
