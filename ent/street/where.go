...
func ID(id int32) predicate.Street {
...
func IDEQ(id int32) predicate.Street {
	return predicate.Street(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDNEQ(id int32) predicate.Street {
	return predicate.Street(func(s *sql.Selector) {
...
func IDIn(ids ...int32) predicate.Street {
	return predicate.Street(func(s *sql.Selector) {
...
func IDNotIn(ids ...int32) predicate.Street {
	return predicate.Street(func(s *sql.Selector) {
		// if not arguments were provided, append the FALSE constants,
		// since we can't apply "IN ()". This will make this predicate falsy.
		if len(ids) == 0 {
...
func IDGT(id int32) predicate.Street {
	return predicate.Street(func(s *sql.Selector) {
...
func IDGTE(id int32) predicate.Street {
	return predicate.Street(func(s *sql.Selector) {
...
func IDLT(id int32) predicate.Street {
	return predicate.Street(func(s *sql.Selector) {
...
func IDLTE(id int32) predicate.Street {
	return predicate.Street(func(s *sql.Selector) {
...
func HasCities() predicate.Street {
	return predicate.Street(func(s *sql.Selector) {
...
func HasCitiesWith(preds ...predicate.City) predicate.Street {
	return predicate.Street(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasAdresses applies the HasEdge predicate on the "adresses" edge.
func HasAdresses() predicate.Street {
	return predicate.Street(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(AdressesTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2M, true, AdressesTable, AdressesPrimaryKey...),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasAdressesWith applies the HasEdge predicate on the "adresses" edge with a given conditions (other predicates).
func HasAdressesWith(preds ...predicate.AddressPlace) predicate.Street {
	return predicate.Street(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(AdressesInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2M, true, AdressesTable, AdressesPrimaryKey...),
		)
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
